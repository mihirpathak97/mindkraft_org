      ...
      <nav class="navbar has-shadow">
        <div class="container">
          <div class="navbar-brand">
            ...
            <a class="navbar-item is-tab is-active">Paintball</a>
          </div>
        </div>
      </nav>
        ...
        $('#button').click(function () {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              Object.keys(payed).forEach(function(key) {
                printWindow.document.write('Game - ' + key.charAt(0).toUpperCase() + key.substr(1) + '<span style="float:right">₹ '+payed[key]+'</span>' + '<br>');
              });

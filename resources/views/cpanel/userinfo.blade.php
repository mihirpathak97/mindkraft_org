        ...
        $('#button').click(function () {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              printWindow.document.write('<img src="https://mindkraft.org/images/mk-cropped.png" width="40px" height="40px" style="float:left; margin-left:120px; margin-top:40px">');
              printWindow.document.write('<h2 align="center">MindKraft 2018</h2><br>');

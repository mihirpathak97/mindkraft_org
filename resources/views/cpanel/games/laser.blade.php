    ...
    <div id="app">
      ...
      <nav class="navbar has-shadow">
        <div class="container">
          <div class="navbar-brand">
            ...
            <a class="navbar-item is-tab is-active">Laser Tag</a>
          </div>
        </div>
      </nav>
      ...
      <?php if ($access_level == 902): ?>
        ...
        $('#button').click(function () {
          ...
          $.ajax({
            type: 'POST',
            url: '/cpanel/user/<?php echo $user->id ?>/register/paintball',
            ...
            success: function (data) {
              ...
              Object.keys(payed).forEach(function(key) {
                printWindow.document.write('Game - ' + key.charAt(0).toUpperCase() + key.substr(1) + ' Tag' + '<span style="float:right">₹ '+payed[key]+'</span>' + '<br>');
              });

                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td style="width:150px;">
                                                              <img alt="Logo" title="" height="auto" src="https://d2yjfm58htokf8.cloudfront.net/static/images/tw_logov2.png"
                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
                                                        <p>Hello,</p>
                                                        <p class="hero">Please confirm your email address.</p>
                                                        <p>This email was sent to you because you registered
                                                            using this id @ <a href="http://mindkraft.org">mindkraft.org</a> </p>
                                                        <p>
                                                          <a href="<?php echo 'http://mindkrafrt.org/verify/'. $id . '/' . hash('sha256', $id) . '/' . $api_token; ?>" class="btn" mc:disable-tracking="">Confirm my email address</a>
                                                        </p>

<?php
  ...
  if (session()->has('cpaneluser') && Controller::checkAdmin(session('cpaneluser'))) {
    Redirect::to('cpanel/console')->send();
  }
?>
    ...
    <div class="container">
        <div class="jumbotron">
          <div class="container">
            ...
            <br>
            <form class="form-inline" action="/cpanel/authenticate" id="login-form" method="post">
              {{ csrf_field() }}
        ...
        <br><br>
        <h4>All Cpanel access will be revoked on 20-03-2018</h4>

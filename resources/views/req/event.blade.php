...
<html lang="{{ app()->getLocale() }}">
  ...
  <body>
    <div id="base-hero" class="select-disable">
      ...
      <div class="item-info">
        <ul>
          <li class="info-list event-list-item">Info</li>
          <li class="info-list event-list-item">Rules</li>
          <li class="info-list event-list-item">Contact</li>
          <li class="info-list event-list-item">Fee</li>
          <li class="info-list event-list-item">Prize</li>
          <li class="info-list register-event">Register</li>
        </ul>
        <div class="info-box">
